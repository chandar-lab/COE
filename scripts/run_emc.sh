...
algos=(emc_mix_episode)
lrs=(0.0001 0.0003 0.0005)
mixer=(qmix)
int_reward_betas=(0.001 0.01 0.1 1.0)
epsilon_starts=(0.0)
seeds=(0 1 2 3 4)
repo_dir="${HOME}/COE"
...
env_name=${env_name//-/_}
hp_token=${algo}_${env_name}_lr${lr}_ic${int_beta}_${mxr}_ep${eps_start}_${seed}
